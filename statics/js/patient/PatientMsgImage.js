	...
	render(){
		return (
			<View style={styles.container} >
				<ViewPager initialPage={0}  tabBarUnderlineColor='#FA7E00'  tabBarActiveTextColor='#000000'>
							...
							<View  style={styles.DfImageCG}>
								<View style={styles.DfImageCGContent}>
									<TouchableOpacity style={styles.btnImage}>
									  <Image source={require('../../images/icon/prepM.png')}>
									  </Image></TouchableOpacity>
									  <Text style={{alignSelf:'center'}}> {'3月1号'}-{'3月7号'} </Text>
									<TouchableOpacity style={styles.btnImage}>
									<Image source={require('../../images/icon/nextM.png')}></Image></TouchableOpacity>
								</View>
							</View>
					</View>
