        ...
        if(!this.state.ListMenu) {
            if(name === 'Menuname') {
                ...
                this.setState({
                    ...
                    modalContent:<MenuModal close={()=>this.closeModal()} navigator = {this.props.navigator} dctname = {dctmsg.name} name='codeModal'/>,
            });
            }
        }
        else{
                ...
                <Image
                    ...
                    <View style={styles.avatarMSG}>
                        <View style = {styles.avatarImage}>
                            ...
                            <View style={styles.imageText}><Text style={{color:'#fff', fontSize:11,borderRadius:6}}>已认证</Text></View>
                        </View>
                        <View><Text style={styles.textBold}>{dctmsg.name}</Text></View>
                        <View><Text style={{color:'#fff', backgroundColor:'transparent',marginTop:10}}>{dctmsg.title}</Text></View>
                    </View>
                </Image>
                {/*headerImage end*/}
